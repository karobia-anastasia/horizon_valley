...
const doctors = [
  {
    ...
    image: profile,
    description:
      "15+ years specializing in elderly care with expertise in age-related conditions.",
  },
  {
    ...
    image: profile,
    description:
      "Expert in cardiovascular health for elderly patients with compassionate care.",
  },
  {
    ...
    image: profile,
    description:
      "Specialized in joint care and mobility solutions for senior patients.",
  },
  {
    ...
    image: profile,
    description:
      "Comprehensive primary care with focus on chronic disease management.",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto text-sm sm:text-base">
            Meet our dedicated team of healthcare professionals specialized in
            elderly care
          </p>
        </div>
